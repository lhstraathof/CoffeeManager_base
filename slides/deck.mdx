...
<div>
  ...
  <p>Manage a list of people to chose from who gets coffee (randomly)</p>
</div>
<div>
  <h3>Requirements:</h3>
  <ul>
    <li>When someone is chosen, he/she can no longer be chosen until the rest is chosen</li>
    <li>Be able to delete added people</li>
  </ul>
</div>
